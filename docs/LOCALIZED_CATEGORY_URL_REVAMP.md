...
EN starter kits: /en/product-category/labelprinters/starterkits
...
NL visitor badges: /product-categorie/labels-en-tickets/bezoekersbadges
NL wine labels: /product-categorie/labels-en-tickets/wijn-labels
NL accessories: /product-categorie/labels-en-tickets/accessoires
```
...
| starterkits | `starterkits` | `starterkits` | `/product-categorie/labelprinters/starterkits` | `/en/product-category/labelprinters/starterkits` |
...
LabelsMenu applicators/accessories: /category/applicatoren
...
| --- | --- | --- | --- | --- | --- |
| labels-root | `labels-en-tickets` / `labels-en-tickets-en` | `labels-en-tickets` | TBD | `/product-categorie/labels-en-tickets` | TBD |
| inkjet | `inkjet-printer-media` | `inkjet-printer-media` | TBD | `/product-categorie/labels-en-tickets/inkjet-printer-media` | TBD |
| thermal-direct | `thermisch-directe-printer-media` | `thermal-direct` | TBD | `/product-categorie/labels-en-tickets/thermal-direct` | TBD |
| thermal-transfer | `thermische-overdracht-printer-media` | `thermal-transfer` | TBD | `/product-categorie/labels-en-tickets/thermal-transfer` | TBD |
| applicators/accessories | `applicatoren` | `accessoires` | TBD | `/product-categorie/labels-en-tickets/accessoires` | TBD |

Known label category-card child mapping:

| Category key | Canonical NL slug | New EN slug | Canonical NL URL | EN URL |
| --- | --- | --- | --- | --- |
| visitor-badges | `bezoekersbadges` | TBD | `/product-categorie/labels-en-tickets/bezoekersbadges` | TBD |
| wine-labels | `wijn-labels` | TBD | `/product-categorie/labels-en-tickets/wijn-labels` | TBD |
| accessories | `accessoires` | TBD | `/product-categorie/labels-en-tickets/accessoires` | TBD |
...
Legacy NL URL slug applicatoren -> may need redirect/alias to canonical NL slug accessoires
...
Canonical NL URL slug accessoires -> filter with the backend NL slug for that same category
```
...
| Accessories | `accessoires` | `/product-categorie/labels-en-tickets/accessoires` | `/category/applicatoren` |

### NL Labels Category-Card Pages

These pages are expected from label category cards/subcategory navigation.

| Page | Filter slug | New NL URL |
| --- | --- | --- |
| Visitor badges | `bezoekersbadges` | `/product-categorie/labels-en-tickets/bezoekersbadges` |
| Wine labels | `wijn-labels` | `/product-categorie/labels-en-tickets/wijn-labels` |
| Accessories | `accessoires` | `/product-categorie/labels-en-tickets/accessoires` |
...
/category/applicatoren
-> /product-categorie/labels-en-tickets/accessoires
```
...
/en/product-category/labelprinters/starterkits
