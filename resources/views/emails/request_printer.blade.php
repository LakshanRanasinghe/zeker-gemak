...
<head>
  ...
  <title>New Printer Request — Businesslabels</title>
</head>
        ...
        <tr>
          <td style="background-color:#f08500;padding:20px 32px;">
            <p style="margin:0;font-size:20px;font-weight:700;color:#ffffff;letter-spacing:-0.01em;">
              New Printer Addition Request
            </p>
            <p style="margin:5px 0 0;font-size:13px;color:#fff3e0;line-height:1.5;">
              A user has requested a new printer to be added to the Product Finder.
            </p>
          </td>
        </tr>
              ...
              <tr>
                <td style="padding:16px 20px;">
                  ...
                  <p style="margin:6px 0 0;font-size:13px;color:#7c2d12;line-height:1.6;">
                    Consider adding this printer to the database, and reply to the user at 
                    <a href="mailto:{{ $data['email'] ?? '' }}" style="color:#f08500;font-weight:600;">{{ $data['email'] ?? '' }}</a> if you have questions or updates.
                  </p>
                </td>
              </tr>
            </table>
