...
<head>
  ...
  <title>Custom-made Label Request — {{ config('app.company.name') }}</title>
</head>
              ...
              <tr>
                <td style="vertical-align:top;">
                  ...
                  <p style="margin:5px 0 0;font-size:12px;color:#475569;line-height:1.6;">
                    ...
                    &nbsp;&middot;&nbsp;
                    <a href="tel:{{ config('app.company.phone') }}"
                      style="color:#64748b;text-decoration:none;">{{ config('app.company.phone') }}</a>
                  </p>
                </td>
