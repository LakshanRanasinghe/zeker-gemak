...
<head>
    ...
    <title>{{ __('order_emails.shipped.title_tag') }}</title>
    <style>
...
<div class="outer">
    ...
    <div class="card">
            ...
            <div class="header-inner">
                <div class="icon-badge">
                    <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M16 16V3H1V16H16Z" fill="rgba(255,255,255,0.15)" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M16 8H20L23 11V16H16V8Z" fill="rgba(255,255,255,0.10)" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <circle cx="5.5" cy="18.5" r="2.5" fill="rgba(255,255,255,0.2)" stroke="white" stroke-width="2"/>
                        <circle cx="18.5" cy="18.5" r="2.5" fill="rgba(255,255,255,0.2)" stroke="white" stroke-width="2"/>
                    </svg>
                </div>
                <h1>{{ __('order_emails.shipped.heading') }}</h1>
                <p>{{ __('order_emails.shipped.intro') }}</p>
        ...
        <div class="banner">
            <p>
                {{ __('order_emails.shipped.greeting', ['name' => $order->billpayer?->firstname ?? __('order_emails.placed.fallback_name')]) }}
        ...
        <div class="section">
            ...
            <div class="row"><span class="label">{{ __('order_emails.common.status') }}</span><span class="value">{{ __('order_emails.status.'.$order->status->value()) }}</span></div>
        </div>
