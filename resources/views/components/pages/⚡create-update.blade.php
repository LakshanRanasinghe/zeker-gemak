...
new class extends Component {
    ...
    public function mount(?Post $page = null)
    {
        if ($page && $page->exists) {
            $this->post = $page;
            ...
            $this->meta_title = (string) $page->getMeta('meta_title');
            $this->meta_description = (string) $page->getMeta('meta_description');
            ...
            foreach ($this->otherLocales() as $locale) {
                $translation = Translation::findByModel($page, $locale);
                if ($translation) {
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <flux:subheading>{{ $post ? __('Update your post details.') : __('Add a new post or page.') }}
                </flux:subheading>
            </div>
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <flux:card class="space-y-6">
                    ...
                    <div class="gap-6 grid grid-cols-1">
                        ...
                        <div>
                            <x-slug-input model="slug" modifier=".blur" placeholder="enter-title" />
                        </div>
                    </div>
